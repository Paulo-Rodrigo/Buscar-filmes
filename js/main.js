...
function buscarFilmes(filmePesquisa){
    axios.get('http://www.omdbapi.com/?s=' + filmePesquisa + '&apikey=d5519192')
...
function mostraFilme(){
   ...
   axios.get('http://www.omdbapi.com/?i=' + filmeID + '&apikey=d5519192')
   .then(function (response) {
     ...
     var mostraFilme = `
        ...
        <div class="col-md-6">
             ...
             <h3>Descrição</h3>
              ${filme.Plot}
              <hr>
              <a href="http://imdb.com/tittle/${filme.imdbID}" target="_blank" class="btn btn-success" pull-left">Ver no IMDB </a>
              <a href="index.htm" target="_blank" class="btn btn-default" pull-right">Voltar a pesquisar </a>
